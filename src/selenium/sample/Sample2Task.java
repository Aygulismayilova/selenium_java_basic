...
//         get third text of class "test" (should be "Test Text 4")
        ...
        List<WebElement> allElementsWithClass = driver.findElements(By.className("test")); //allElementsWithClass - any name
//
        /* for (int i = 0; i < allElementsWithClass.size; i++());
            allElementsWithClass.get(i).getText());
        */

        for (WebElement elementWithClass : allElementsWithClass) {      //elementWithClass - any name

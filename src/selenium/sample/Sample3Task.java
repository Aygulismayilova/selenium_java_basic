...
//         fail with custom error message:
        ...
        assertTrue(" This is an error ", elementTextOnPage.equalsIgnoreCase("This is also a button"));
...
//        check that it is False that value of second button is "This is a button"
        String elementTextOnPage = driver.findElement((By.name("randomButton2"))).getAttribute("value");
        assertFalse(" This is an error ", elementTextOnPage.equalsIgnoreCase("This is  a button"));
    }
...
//        contain number 190
        ...
        for (WebElement element : Eleme) {
                assertTrue(!element.getText().contains("190"));
        }
    }
}